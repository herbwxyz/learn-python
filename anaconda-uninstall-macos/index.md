...
ターミナルに、次のコマンドを打ち込んでエンターを押してください。
...
さて、これでMacからAnacondaを完全にアンインストールすることができました。ターミナルは閉じて大丈夫です。

テキストのAnacondaのインストールの手順に沿って、再度インストールを進めてみてください。

[>> 第１回：Mac へのインストールと起動方法](../01/install/anaconda_mac/)
